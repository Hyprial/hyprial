...
if (!deps) throw new Error('Install dashboard browser dependencies, or set DSH_GUI_BROWSER_DEPS to a package.json resolving React, React DOM, rolldown and Playwright.');
